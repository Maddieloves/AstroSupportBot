...
def check_support(ctx, bot):
    try:
        server = bot.get_guild(1295475536864477246)
        role1 = discord.utils.get(server.roles, id=1295481656748281938)
        role2 = discord.utils.get(server.roles, id=1295481656727306361)
        role3 = discord.utils.get(server.roles, id=1295481656727306359)
        if (
